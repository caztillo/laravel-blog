                         ...
                         <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group required has-feedback {{ ($error = $errors->first('tags')) ? 'has-error' : '' }}">
                                    <strong>Tags:</strong>
                                    <select name="tags[]" data-ajax--url="{{url('admin/tags')}}" data-ajax--cache="true" multiple="multiple" data-minimumInputLength="3" data-placeholder="Tags" data-tags="true" data-allow-clear="true" class="form-control select2-ajax"></select>
